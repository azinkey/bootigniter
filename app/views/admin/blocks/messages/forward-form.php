                        ...
                        <div class="row-fluid">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="field-row">
                                    ...
                                    echo form_multiselect('users[]', $user_options, NULL, ' class="chosen" data-placeholder="To Users.."');
                                    ?>
                                </div>
                                <div class="field-row">
                                    <?php
                                    ...
                                    echo form_input(array(
                                        'class' => 'form-control',
                                        'name' => 'subject',
                                        'value' => (isset($message->subject)) ? 'FW: ' . $message->subject : '',
                                    ));
                                    ?>
                                </div>
                                <div class="field-row">
                                    ...
                                    echo form_textarea(array(
                                        'class' => 'form-control',
                                        'name' => 'body',
                                        'value' => (isset($message->body)) ? $message->body : '',
                                    ));
                                    ?>    
                                </div>
