<div data-ride="carousel" class="carousel slide" id="frontCarousel">
    <!-- Indicators -->
    <ol class="carousel-indicators">
        <li data-slide-to="0" data-target="#frontCarousel" class="active"></li>
        <li data-slide-to="1" data-target="#frontCarousel"></li>
        <li data-slide-to="2" data-target="#frontCarousel" ></li>
        <li data-slide-to="3" data-target="#frontCarousel" ></li>
        <li data-slide-to="4" data-target="#frontCarousel" ></li>
    </ol>
    <div class="carousel-inner">
        ...
        <div class="item">
            <div class="container">
                <div class="carousel-caption">
                    <h1>Infinite Scalability</h1>
                    <p>Deploy, scale and monitor your app with our Intuitive and Powerful Content Management System (CMS). A very Sleek API pattern for developers to extend the power of Codeigniter.</p>
        ...
        <div class="item">
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <p><a role="button" href="#" class="btn btn-lg btn-success"> <i class="glyphicon glyphicon-download-alt"></i> Download</a></p>
                </div>
            </div>
        </div>

    </div>
    <a data-slide="prev" href="#frontCarousel" class="left carousel-control">
        <span class="glyphicon glyphicon-chevron-left"></span>
    </a>
    <a data-slide="next" href="#frontCarousel" class="right carousel-control">
